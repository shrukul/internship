                    ...
                    <table id="dt_tableTools" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                         <?php
                            ...
                            $placed = mysql_query("SELECT department,COUNT(*) AS placed FROM student WHERE company_placed IS NOT NULL GROUP BY department");
                            $total = mysql_query("SELECT department,COUNT(*) AS total FROM student GROUP BY department");
                            ...
                            while($row = mysql_fetch_array($placed)) {
                                $array1[$i++] = $row;
                            }
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $array1[$i]['department']?></td>
                                    <td><?php echo $array2[$i]['total']?></td>
                                    <td><?php echo $array1[$i]['placed']?></td>
                                    <td><?php echo ($array2[$i]['total']-$array1[$i]['placed'])?></td>
                                    <td><?php echo substr(number_format((($array1[$i]['placed']/$array2[$i]['total'])*100),3,'.',''),0,-1) ?></td>
                                </tr>
