...
altair_dashboard = {
    init: function () {
        ...
        // animated chart (server load)
        altair_dashboard.c3_charts();
        // video player
    ...
    c3_charts: function() {
        ...
        if($(c3_server_load_id).length) {
            var server_1 = c3.generate({
                ...
                color: {
                    pattern: ['#388E3C', '#F57C00', '#D32F2F' ], // the three color levels for the percentage values.
                    threshold: {
                        values: [8, 14, 20]
                    }
                },
            ...
            setInterval(function () {
                var randUsage = Math.floor(Math.random() * 18);
                server_1.load({
            ...
            $video_playlist.on('click', 'li' ,function(e) {
                ...
                if(!$this.hasClass(active_class)) {
                    var this_src = $this.attr('data-video-src'),
                        iframe_embed = '<iframe height="150" src="https://www.youtube-nocookie.com/embed/' + this_src + '?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>'
