<?php defined('safe_access') or die('Restricted access!'); ?>
    ...
    <div id="page_content">
        <div id="page_heading">
            <h1>Samsung Galaxy S6 edge, 64GB, Black</h1>
                                ...
                                <div class="uk-width-large-1-2">
                                    <div class="uk-grid uk-grid-small">
                                        ...
                                        <div class="uk-width-large-2-3">
                                            <span class="uk-text-large uk-text-middle"><a href="#">Galaxy S6 edge</a></span>
                                        </div>
                                    </div>
                                ...
                                <div class="uk-width-medium-8-10">
                                    <table class="uk-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>White</td>
                                                <td><i class="material-icons md-24">&#xE835;</i></td>
    ...
    <div class="md-fab-wrapper">
        <a class="md-fab md-fab-primary" href="ecommerce_product_edit.html">
